export default {
  ...
  "color.gradientHint": "Click bar to add a stop · Click handle to select · Drag to move",
  ...
  "color.stopPropsHeading": "Selected stop",
  "color.stopColor": "Color",
  "color.stopPosition": "Position",
  "color.stopLockToBase": "Lock to base color",
  "color.stopRemove": "Remove stop",
  "color.paletteLabel": "Will export as:",
  "color.snapPreview": "Show as printed colors",
  "color.gradientReset": "↺ Reset",
  "tooltips.colorSnapPreview": "Show the live preview using exactly the exported colors instead of a smooth gradient. More accurate to what your slicer will print.",
  "tooltips.colorGradientReset": "Restore the default 2-stop greyscale gradient.",
